...
const CreatePost = () => {
  ...
  const[generatingImg, setGeneratingImg] = useState(false); //başta false yaptığımızda bize bir şey göstermez. true yaparsak gösterir
  ...
  return (
    <section className='max-w-7xl mx-auto'>
      ...
      <p className='mt-2 text-[#666e75] text-[15px] max-w-[750px]'>
        ...
        <div className='flex flex-col gap-5'>
          ...
          h-64 flex justify-center items-center'>
            ...
            {generatingImg && (
              ...
              flex justify-center items-center bg-[rgba(0,0,0,0.5)]
              rounded-lg'>
                <Loader />
              </div>
            )}
